...
Usage:
    python scripts/video_pipeline.py --video resources/VR.mkv --prompt "spoon"
    python scripts/video_pipeline.py --video resources/VR.mkv --prompt "spoon" --vlm-interval 30
"""
